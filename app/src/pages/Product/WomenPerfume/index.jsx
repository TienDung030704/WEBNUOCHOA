  ...
  return (
    <div className="catalog-page-enter min-h-screen bg-[#1b1b1b] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/8 bg-[#121212] pt-[132px] pb-16">
        <div className="absolute inset-y-0 left-0 w-full max-w-[440px] bg-black/35 backdrop-blur-[18px]" />
        <div className="absolute inset-y-0 left-0 w-[36%] bg-gradient-to-r from-[#5a2437]/60 via-black/20 to-transparent" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(214,130,165,0.16),transparent_38%)]" />

        <div className="relative z-10 mx-auto flex max-w-[1280px] flex-col items-center px-[22px] text-center">
          ...
          <div className="mt-5 flex items-center gap-3 text-sm text-white/68">
            ...
            <span>Nước hoa</span>
            <ChevronRight size={15} />
            <span className="text-white">Nước hoa nữ</span>
          </div>
        </div>
      </section>
